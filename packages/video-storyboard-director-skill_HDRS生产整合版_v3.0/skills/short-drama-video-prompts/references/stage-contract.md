...
| VID-23 | reviewed_invariant | Motion inherits the accepted commercial shot duration and never extends it. A shot over 3 seconds must already carry storyboard justification for a continuous long line, action causality, spatial relationship, emotional hold, key blocking, or designed long take, and its motion text makes the accepted within-shot attention changes executable. It never pads the interval with invented action or camera drift. |
